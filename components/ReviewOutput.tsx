...
export const ReviewOutput: React.FC<ReviewOutputProps> = ({ feedback, isLoading, isChatLoading, loadingAction, error, onSaveVersion, isChatMode, isActive, outputType }) => {
  ...
  const title = useMemo(() => {
    ...
    if (isChatMode) return 'Live Response';
  ...
  }, [isChatMode, showLoading, loadingAction, outputType]);
