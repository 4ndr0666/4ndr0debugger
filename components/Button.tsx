...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variantStyles = {
    primary: "bg-[#101827] text-[#e0ffff] border border-[#15adad]/60 shadow-xl shadow-[#156464]/30 hover:border-[#15fafa]/80 hover:shadow-lg hover:shadow-[#15fafa]/50 focus:ring-[#15adad] focus:ring-offset-[#0A0F1A]",
